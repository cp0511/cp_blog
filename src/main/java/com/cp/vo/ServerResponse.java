...
public class ServerResponse {
	...
	public static ServerResponse createByError() {
		return new ServerResponse(ResponseCode.SERVER_ERROR.getCode(),ResponseCode.SERVER_ERROR.getDesc());
	}

	public static ServerResponse createByError(String errorMessage) {
		return new ServerResponse(ResponseCode.SERVER_ERROR.getCode(), errorMessage);
	}
